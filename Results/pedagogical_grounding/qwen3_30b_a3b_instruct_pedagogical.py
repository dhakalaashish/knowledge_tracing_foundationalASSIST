"""
Pedagogical Grounding benchmark with Qwen3-30B-A3B-Instruct-2507 model.
...
Usage:
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3 python qwen3_30b_a3b_instruct_pedagogical.py \
        --task difficulty \
        --data-dir . \
        --num-gpus 4 \
        --num-samples 1000 \
